...
<html lang="en">
<head>
	<title>Signup Musicplayer</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					session_start();
							...
							echo 	'<div class="text-center p-t-90" style="color: black; font-size: 20px;">'.
									$_SESSION["singupmessage"].'</div>';
					...
					<div class="wrap-input100 validate-input" data-validate = "Emaail">
...
<!-- 					<div class="contact100-form-checkbox">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="login.php?id=true">
							Log in
						</a>
					</div>
